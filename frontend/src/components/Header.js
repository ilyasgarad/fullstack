    ...
    <header className='h-16 shadow-md bg-white fixed w-full z-40'>
      <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
            <div className=''>
                <Link to={"/"}>
                    {/* <Logo w={90} h={50}/> */}
                    <h1 className='font-bold'>Caraf Perfumes</h1>
                </Link>
            </div>
            ...
            <div className='flex items-center gap-7'>
                ...
                <div>
                  {
                    user?._id  ? (
                      <button onClick={handleLogout} className='px-3 py-1 rounded-full text-white bg-blue-500 hover:bg-blue-900'>Logout</button>
                    )
                    : (
                    <Link to={"/login"} className='px-3 py-1 rounded-full text-white bg-blue-500 hover:bg-blue-900'>Login</Link>
                    )
                  }
